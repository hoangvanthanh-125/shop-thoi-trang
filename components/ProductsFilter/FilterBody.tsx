  ...
  return (
    <div
        ...
        >
          ...
          <div className={style.wrapFilter__body__item}>
            <div className={style.title}>Kích cỡ</div>
            <div className={style.content}>
              {listSize.map((item) => (
                <div
                  onClick={() => setSize(item)}
                  className={`${style.content__size} ${
                    item === size && style.content__sizeActive
                  }`}
                  key={item}
                >
                  {item}
          ...
          <div className={style.wrapFilter__body__item}>
            <div className={style.title}>Màu sắc chính</div>
            <div className={style.content}>
              {listColor.map((item) => (
                <div
        ...
        <div className={style.wrapFilter__action}>
          <button className={style.filterAction}>Lọc</button>
